...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.3.21
	github.com/hedzr/store/codecs/hjson v1.3.21
	github.com/hedzr/store/codecs/json v1.3.21
	github.com/hedzr/store/codecs/nestext v1.3.21
	github.com/hedzr/store/codecs/toml v1.3.21
	github.com/hedzr/store/codecs/yaml v1.3.21
	github.com/hedzr/store/providers/env v1.3.21
	github.com/hedzr/store/providers/file v1.3.21
	github.com/hedzr/store/providers/flags v1.3.21
	github.com/hedzr/store/providers/fs v1.3.21
	github.com/hedzr/store/providers/maps v1.3.21
