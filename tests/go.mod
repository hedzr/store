...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.4.3
	...
	github.com/hedzr/store/codecs/yaml v1.4.3
	...
	github.com/hedzr/store/providers/fs v1.4.3
	github.com/hedzr/store/providers/maps v1.4.3
